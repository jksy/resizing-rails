...
wget "https://cdn.jsdelivr.net/npm/${VERSION}/dist/js/bootstrap.bundle.min.js" -P $ROOT_DIR/app/assets/javascripts/resizing/rails/bootstrap/
...
wget "https://cdn.jsdelivr.net/npm/${VERSION}/dist/css/bootstrap.min.css" -P $ROOT_DIR/app/assets/stylesheets/resizing/rails/bootstrap/
